...
from mainapp.models import Book, Magazine, Category, LatestProduct, Customer, CartProduct
...
class BaseView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        products = LatestProduct.objects.get_products_for_main_page(
            'book', 'magazine', with_respect_to='book'
        )
        context = {
...
class ProductDetailView(CartMixin, CategoryDetailMixin, DetailView):
    ...
    def dispatch(self, requests, *args, **kwargs):
        ...
        return super().dispatch(requests, *args, **kwargs)
